...
### Application Back-end (Server) - up to 40% - Everyone

- At least **5 different public dynamic web pages** - **Spasi, Mitko**
  - Using [Pug](https://pugjs.org/)
- At least **3 different private (authenticated) dynamic web pages** - **Spasi,  Mitko**
  - Using [Pug](https://pugjs.org/)
- At least **5 different public RESTful routes** for AJAX - **Mitko**
- At least **1 private (authenticated) route** for AJAX -  **Mitko**
- Use **Express** for the server - **Everyone**
- Use **MongoDB** - **Everyone (Mainly Mitko :D)**
  - As data storage
  - Do not use Mongoose
- Create a data/service layer for accessing the database - **Everyone (Mainly Mitko :D)**
- Use [Passport](http://passportjs.org/) - for managing **users** - **Mitko**
- Implement WebSockets
  - Using Socket.io or anything else

### Application front-end (client) - up to 25% - Everyone
...
- Unit test your application backend - **Spasi, Mitko**
- Write functional tests with selenium - **Spasi** 
  - Any webdriver is Ok
    - Gecko, Chrome, PhantomJS, SlimerJS, etc...
  - Test 50% of the application routes
    - Less will not win the points
- Write integration tests for AJAX routes - **Spasi, Mitko**
  - With supertest

### Deployment in Amazon Web Services (AWS) - up to 10% - Mitko
